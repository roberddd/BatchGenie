...
<br>**Note:** Blender 5.1 updates its internal Python version, which requires separate builds. BatchGenie is therefore provided in two versions: one for Blender 4.2-5.0 and one for 5.1+.
